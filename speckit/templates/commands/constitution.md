...
2. Collect/derive values for placeholders:
   ...
   - If version bump type ambiguous, propose reasoning before finalising.
...
4. Consistency propagation checklist (convert prior checklist into active validations):
   ...
   - Read `speckit/templates/tasks-template.md` and ensure task categorisation reflects new or removed principle-driven task types (e.g., observability, versioning, testing discipline).
